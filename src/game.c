        ...
        case STATE_DRAWING:
            {
                ...
                DrawCircle(SCREEN_WIDTH / 2, 35, 30, (Color){255, 100, 100, 255});
                ...
                DrawRectangleRounded((Rectangle){(float)frame_x + 10, (float)frame_y + 10, (float)frame_w, (float)frame_h}, 0.1f, 10, (Color){255, 220, 80, 255});
                DrawRectangleRounded((Rectangle){(float)frame_x, (float)frame_y, (float)frame_w, (float)frame_h}, 0.1f, 10, (Color){40, 44, 52, 255});
                ...
                DrawRectangle(20, 15, pw + 20, 30, (Color){50, 200, 255, 255});
